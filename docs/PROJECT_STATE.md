...
## Current branch milestone — R4 Experience Compiler and Judge local candidate
...
1. Obtain protected Linux/Windows acceptance for R4 and integrate its one compiled recovery episode plus deterministic Evidence Judge.
