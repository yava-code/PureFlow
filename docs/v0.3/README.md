...
- The v0.3 Dual-Control product runtime is not implemented. R0a contains canonical hashing and fail-closed fixture-contract validation; the R0b deterministic fixture/runtime candidate is implemented locally and awaits independent Windows/Linux PR verification before R0 is complete.
